...
# IMPORTANT: For update instructions, see README.md.
{
  ...
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/meditation/resources.grd": {
    "META": {"sizes": {"includes": [5],}},
    "includes": [4365],
  },
 ...
 "<(SHARED_INTERMEDIATE_DIR)/ash/webui/projector_app/resources/app/untrusted/resources.grd": {
  ...
  "<(SHARED_INTERMEDIATE_DIR)/components/focus_onboarding/resources.grd": {
   "META": {"sizes": {"includes": [64],}},
    "includes": [7510],
  },
  ...
  "<(SHARED_INTERMEDIATE_DIR)/third_party/focus_youtube/focus_youtube_resources.grd": {
    "META": {"sizes": {"includes": [20]}},
    "includes": [10090],
  },
