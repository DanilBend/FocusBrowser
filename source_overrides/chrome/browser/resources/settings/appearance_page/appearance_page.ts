...
// This must be kept in sync with the FocusLayoutType enum in
// chrome/browser/ui/focus/focus_layout_state_controller.h.
enum BrowserLayout {
  CLASSIC = 0,
  COMPACT = 1,
  VERTICAL = 2,
...
export class SettingsAppearancePageElement extends
    ...
    return {
      ...
      browserLayoutOptions_: {
        ...
        value() {
          return [
            {
              value: BrowserLayout.CLASSIC,
              name: loadTimeData.getString('browserLayoutClassic'),
            },
            {
              value: BrowserLayout.DYNAMIC,
              name: loadTimeData.getString('browserLayoutDynamic'),
            },
            {
      ...
      showVerticalSettings_: {
        type: Boolean,
        computed:
          'computeShowVerticalSettings_(prefs.focus.browser.layout.value)',
      },
  ...
  private computeShowVerticalSettings_(layout: number|undefined): boolean {
    return this.showVerticalTabsEnabled_ && layout === BrowserLayout.VERTICAL;
  }

  private showCenteredLocationBarSetting_(layout: number|undefined): boolean {
    return layout !== BrowserLayout.COMPACT;
  }
