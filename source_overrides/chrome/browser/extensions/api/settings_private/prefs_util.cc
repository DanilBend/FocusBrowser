...
const PrefsUtil::TypedPrefMap& PrefsUtil::GetAllowlistedKeys() {
  ...
  // Focus Browser layout
  (*s_allowlist)[::prefs::kFocusLayout] = settings_api::PrefType::kNumber;
  (*s_allowlist)[::prefs::kFocusVerticalRightAligned] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusCenteredLocationBar] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusMinimalLocationBar] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusZenMode] = settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusZenModeSidebarPinned] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusZenModeTopChromePinned] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusNativeFrameMaterials] =
      settings_api::PrefType::kBoolean;
  ...
  (*s_allowlist)[::prefs::kShiftRightClickContextMenu] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kShowZoomIndicator] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusRoundedFrame] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusMotionEnabled] =
      settings_api::PrefType::kBoolean;
  ...
  // Focus Browser toolbar settings.
  ...
  (*s_allowlist)[::prefs::kShowMediaButton] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kShowVerticalTabsCollapseButton] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kShowDynamicNewTabButton] =
      settings_api::PrefType::kBoolean;
  ...
  // Focus Browser services page
  (*s_allowlist)[::prefs::kFocusServicesEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusExtProxyEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusBangsEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusSpellcheckEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusUpdateFetchingEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusUBlockAssetsEnabled] =
      settings_api::PrefType::kBoolean;
  (*s_allowlist)[::prefs::kFocusServicesOrigin] =
      settings_api::PrefType::kString;
  (*s_allowlist)[::prefs::kFocusServicesConsented] =
      settings_api::PrefType::kBoolean;
