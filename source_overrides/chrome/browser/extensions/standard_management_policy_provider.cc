...
bool AdminPolicyIsModifiable(ExtensionManagement* settings,
  ...
  // Browser components are not user-modifiable. FocusBlock and FocusYoutube
  // expose feature-level switches in their browser-owned panels while their
  // internal engines remain loaded and cannot be disabled or removed through
  // extension APIs.
