...
class ToolbarView : public views::AccessiblePaneView,
 ...
 public:
  ...
  // Resets extension-related toolbar container animations so they don't animate
  // while zen mode is revealing the toolbar.
  void AbortToolbarContainerAnimationsForZenReveal();
 ...
 private:
  ...
  // Returns whether the Focus Browser layout is Compact.
  ...
  void OnShowFocusBlockButtonChanged();

  void OnShowFocusYoutubeButtonChanged();
  ...
  BooleanPrefMember show_focus_block_button_;

  BooleanPrefMember show_focus_youtube_button_;
