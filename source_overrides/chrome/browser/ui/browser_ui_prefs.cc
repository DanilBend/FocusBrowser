...
void RegisterBrowserPrefs(PrefRegistrySimple* registry) {
  ...
  registry->RegisterTimePref(prefs::kDefaultBrowserFirstShownTime,
                             base::Time());
  registry->RegisterBooleanPref(prefs::kFocusDefaultBrowserRejected, false);
...
void RegisterBrowserUserPrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterBooleanPref(prefs::kShiftRightClickContextMenu, true);

  registry->RegisterBooleanPref(prefs::kShowZoomIndicator, true);

  registry->RegisterBooleanPref(prefs::kFocusRoundedFrame, true);

  registry->RegisterBooleanPref(prefs::kFocusNativeFrameMaterials, false);

  registry->RegisterBooleanPref(prefs::kFocusCenteredLocationBar, false);

  registry->RegisterBooleanPref(prefs::kFocusMinimalLocationBar, false);
  ...
  {
    registry->RegisterIntegerPref(prefs::kFocusSchemaVersion, 0);
    registry->RegisterBooleanPref(prefs::kFocusDisableSchemaAlerts, false);
    registry->RegisterBooleanPref(prefs::kFocusServicesEnabled, false);
    registry->RegisterBooleanPref(prefs::kFocusBangsEnabled, false);
    registry->RegisterBooleanPref(prefs::kFocusExtProxyEnabled, false);
    registry->RegisterBooleanPref(prefs::kFocusSpellcheckEnabled, false);
    registry->RegisterStringPref(prefs::kFocusServicesOrigin, "");
    registry->RegisterBooleanPref(prefs::kFocusDidOnboarding, false);
    registry->RegisterBooleanPref(prefs::kFocusServicesConsented, false);
#if BUILDFLAG(IS_WIN)
    registry->RegisterBooleanPref(prefs::kFocusUpdateFetchingEnabled,
                                  BUILDFLAG(ENABLE_UPDATE_NOTIFICATIONS));
#else
    registry->RegisterBooleanPref(prefs::kFocusUpdateFetchingEnabled, false);
#endif
    registry->RegisterBooleanPref(prefs::kFocusUBlockAssetsEnabled, false);
  }
