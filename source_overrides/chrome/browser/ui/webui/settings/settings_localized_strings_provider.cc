...
void AddAppearanceStrings(content::WebUIDataSource* html_source,
  ...
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"focusMotion", IDS_SETTINGS_FOCUS_MOTION},
      {"focusMotionDescription", IDS_SETTINGS_FOCUS_MOTION_DESCRIPTION},
      ...
      {"autoPinNewTabGroups", IDS_SETTINGS_AUTO_PIN_NEW_TAB_GROUPS_FOCUS},
  ...
  html_source->AddBoolean("showNativeFrameMaterialsOption",
                          features::FocusNativeFrameAvailable());
...
void AddPersonalizationOptionsStrings(content::WebUIDataSource* html_source) {
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"searchSuggestPref", IDS_SETTINGS_SUGGEST_PREF_FOCUS},
      {"searchSuggestPrefDesc", IDS_SETTINGS_SUGGEST_PREF_DESC_FOCUS},
...
void AddPrivacyStrings(content::WebUIDataSource* html_source,
  ...
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"focusBrowserUpdatesLabel", IDS_SETTINGS_FOCUS_BROWSER_UPDATES},
      {"focusBrowserUpdatesDescription",
      ...
      {"doNotTrackDialogMessage", IDS_SETTINGS_ENABLE_DO_NOT_TRACK_DIALOG_TEXT_FOCUS},
  ...
  html_source->AddLocalizedStrings(kLocalizedStrings);
  html_source->AddBoolean("focusUpdaterAvailable",
#if BUILDFLAG(IS_WIN)
                          BUILDFLAG(ENABLE_UPDATE_NOTIFICATIONS)
#else
                          false
#endif
  );
...
void AddSearchStrings(content::WebUIDataSource* html_source, Profile* profile) {
  ...
  html_source->AddLocalizedString(
      ...
      IDS_SEARCH_ENGINE_CHOICE_SETTINGS_SUBTITLE_FOCUS);
...
void AddSiteSettingsStrings(content::WebUIDataSource* html_source,
  ...
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"trackingProtectionSitesAllowedCookiesDescription",
       IDS_SETTINGS_ALLOWED_THIRD_PARTY_COOKIES_DESCRIPTION_FOCUS},
...
void AddSystemStrings(content::WebUIDataSource* html_source) {
  static constexpr webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"shortcutsPageTitle", IDS_SETTINGS_SHORTCUTS_TITLE},
      {"shortcutsSearchLabel", IDS_SETTINGS_SHORTCUTS_SEARCH_LABEL},
      {"shortcutsRemoveA11yLabel", IDS_SETTINGS_SHORTCUTS_REMOVE_A11Y_LABEL},
      {"shortcutsReset", IDS_SETTINGS_SITE_SETTINGS_SITE_RESET_ALL},
      {"shortcutsResetAll", IDS_SETTINGS_SHORTCUTS_RESET_ALL},
      {"shortcutsAddDialogTitle", IDS_SETTINGS_SHORTCUTS_ADD_DIALOG_TITLE},
      {"shortcutsResetDialogTitle", IDS_SETTINGS_SHORTCUTS_RESET_ALL},
      {"shortcutsResetDialogDescription",
       IDS_SETTINGS_SHORTCUTS_RESET_DIALOG_DESCRIPTION},
      {"shortcutsPressShortcut", IDS_SETTINGS_SHORTCUTS_PRESS_SHORTCUT},
      {"shortcutsNeedKey", IDS_SETTINGS_SHORTCUTS_NEED_KEY},
      {"shortcutsWillOverride", IDS_SETTINGS_SHORTCUTS_WILL_OVERRIDE},
      {"shortcutsSystemConflict", IDS_SETTINGS_SHORTCUTS_SYSTEM_CONFLICT},
      {"shortcutsInvalid", IDS_SETTINGS_SHORTCUTS_INVALID},
#if BUILDFLAG(IS_MAC)
      {"shortcutsMacSystemSettingsNotice",
       IDS_SETTINGS_SHORTCUTS_MAC_SYSTEM_SETTINGS_NOTICE},
      {"shortcutsMacSystemSettingsLink",
       IDS_SETTINGS_SHORTCUTS_MAC_SYSTEM_SETTINGS_LINK},
#endif
#if BUILDFLAG(IS_WIN) && BUILDFLAG(GOOGLE_CHROME_BRANDING)
  ...
  html_source->AddLocalizedStrings(kLocalizedStrings);
  html_source->AddBoolean(
      "showCustomizableBrowserShortcuts",
