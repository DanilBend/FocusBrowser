<script lang="ts">
    ...
    import { passwordManagerIcons } from "../lib/brand-icons";
    ...
    import FocusPartner from "./FocusPartner.svelte";
...
<style>
    .pm-option {
        ...
        background-color: var(--focus-elevated-5);
        box-shadow: 0 0 0 1.5px var(--focus-elevated-5) inset;
    }
    ...
    .pm-icon-container {
        background: var(--focus-elevated-10);
        display: flex;
