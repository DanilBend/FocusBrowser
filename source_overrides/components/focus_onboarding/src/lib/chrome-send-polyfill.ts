...
import { FocusImportType, type FocusImportTypes, type ExtensionStatus, type InstallError } from './browser';
...
const importerListSimple = [
    ...
    [ "Yandex", "Example search engine", chrome_has_favs ],
...
const _send_polyfill = (msg: string, params?: any[]) => {
    ...
    if (msg === 'getPrefs') {
        ...
        if (msg !== 'importFromBookmarksFile') {
            ...
            const imports: FocusImportTypes = params![1];
            ...
            const necessary_keys = Object.values(FocusImportType);
    ...
    } else if (msg === 'applyFocusSettings' || msg === 'setNtpShortcuts') {
