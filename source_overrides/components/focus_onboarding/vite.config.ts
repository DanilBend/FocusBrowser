...
export default defineConfig({
    ...
    build: {
        target: 'chrome140',
        // WebUI serves generated files from its own trusted origin. Keeping
        // brand icons as files avoids data-URL CSP failures that left shortcut
        // and search-engine logo slots empty in packaged builds.
        assetsInlineLimit: 0,
    }
});
