...
<cr-iconset name="cr" size="24">
  <svg>
    <defs>
      ...
      <g id="chrome-product" viewBox="0 0 56 56" fill="none"
          stroke="currentColor">
        <circle cx="28" cy="28" r="19.25" stroke-width="2.40625"></circle>
        <circle cx="28" cy="28" r="8.09375" stroke-width="2.1875"></circle>
        <path d="M28 14V18.375M37.625 28H42M28 37.625V42M14 28H18.375"
            stroke-width="2.1875" stroke-linecap="round"></path>
        <circle cx="28" cy="28" r="2.625" fill="currentColor"
            stroke="none"></circle>
      </g>
      <g id="close">
        <path
      ...
      <!-- source: https://fonts.9oo91e.qjz9zk/icons?selected=Material+Symbols+Outlined:family_link:FILL@0;wght@0;GRAD@0;opsz@24&icon.size=24&icon.color=%23e8eaed -->
