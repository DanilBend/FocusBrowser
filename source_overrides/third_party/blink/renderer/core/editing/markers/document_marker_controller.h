...
class CORE_EXPORT DocumentMarkerController final
 ...
 public:
  ...
  void AddFocusTextMotionMarker(
      const Text&,
      unsigned start_offset,
      unsigned end_offset,
      base::TimeDelta start_delay = base::TimeDelta());
  void AddFocusTextDeletionMotionMarker(const Text&,
                                        unsigned start_offset,
                                        unsigned end_offset);
  ...
  void ContinueFocusTextMotionAnimation(base::TimeTicks tick);
 ...
 private:
  ...
  void StartFocusTextMotionAnimationIfNeeded();
  bool UpdateFocusTextMotionOpacity(base::TimeTicks tick);
  void InvalidatePaintForFocusTextMotionMarkers();
  ...
  bool focus_text_motion_animation_running_ = false;
