...
struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::WebPreferencesDataView,
  ...
  static bool shift_right_click_context_menu_enabled(
      const blink::web_pref::WebPreferences& r) {
    return r.shift_right_click_context_menu_enabled;
  }
  ...
  static bool focus_text_motion_enabled(
      const blink::web_pref::WebPreferences& r) {
    return r.focus_text_motion_enabled;
  }
