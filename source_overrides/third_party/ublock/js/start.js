...
const onFirstFetchReady = (fetched, adminExtra) => {
    ...
    // The built-in FocusBlock master switch is on by default and survives
    // browser restarts without altering the user's per-site trusted list.
    µb.focusGlobalEnabled = fetched.focusGlobalEnabled !== false;
