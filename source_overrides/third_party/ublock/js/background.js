...
const userSettingsDefault = {
    ...
    // Focus Browser starts its built-in protection in the black-and-white
    // Focus theme. Users can still choose another monochrome theme later.
    uiTheme: 'dark',
    externalLists: '',
...
const µBlock = {  // jshint ignore:line
    ...
    // Browser-owned master switch. This is intentionally independent from
    // uBlock's per-site trusted list so turning FocusBlock back on restores
    // every site-specific choice exactly as the user left it.
