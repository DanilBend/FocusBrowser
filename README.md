...
интерфейс браузера. Версия 1.0.2 основана на Chromium 150.0.7871.128 и рассчитана
...
Установщик версии 1.0.2 пока не подписан Authenticode, поэтому Windows SmartScreen
...
В версии 1.0.2 встроен диалог обновления при следующем запуске, однако он
