...
интерфейс браузера. Версия 1.0.1 основана на Chromium 150.0.7871.128 и рассчитана
...
Установщик версии 1.0.1 пока не подписан Authenticode, поэтому Windows SmartScreen
...
Автоматическое производственное обновление в бинарнике 1.0.1 ещё не включено:
