# Focus Browser i18n
This directory contains the translations for Focus Browser browser UI strings.
...
- "Focus Browser" and other brand names should not be translated
...
## Development
When adding strings to Focus Browser, you might need to regenerate the source
