...
"""Script to replace upstream browser names with Focus Browser."""
...
def replacement_sanity():
    ...
    before_after = [
        ('chrome://about', 'focus://about'),
        ('focus://version', 'focus://version'),
        ('focus.desktop', 'focus-browser.desktop'),
        ('Focus', 'Focus Browser'),
        ('Chrome Root Program', 'Chrome Root Program'),
        (' Chrome  ', ' Focus Browser  '),
        ('Chrome Web Store', 'Chrome Web Store'),
        ('Chromium Web Store', 'Chromium Web Store'),
        ('Chrome Remote Desktop', 'Chrome Remote Desktop'),
        ('Google Chrome', 'Focus Browser'),
        ('Chrome Google Chrome Chrome Chromium',
         'Focus Browser Focus Browser Focus Browser Focus Browser'),
        ('Chrome', 'Focus Browser'),
        ('Chromium', 'Focus Browser'),
    ]
