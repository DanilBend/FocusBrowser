...
"""Utilities for applying Focus Browser branding to localized strings."""
...
REPLACEMENT_REGEXES_STR = [
    ...
    # main replacement(s)
    (r'focus://', r'focus://'),
    (r'focus\.desktop', r'focus-browser.desktop'),
    (r'\bFocus\b', r'Focus Browser'),
    (r'(\b)chrome://', r'\1focus://'),
    (r'(?:Google )?Chrom(e|ium)(?!\w)', r'Focus Browser'),
...
def replace_text(text):
    """Replaces upstream product names and schemes with Focus Browser."""
    had_match = False
...
def replace_xtb_translation(msg, fp_map):
    """
    Replaces upstream product names and schemes with Focus Browser in a
    .xtb <translation>.
    """
...
def replace_grit_tree(text):
    """Replaces upstream product names with Focus Browser, where desired."""
...
def dedup_translations_in_place(translation, seen):
    ...
    # "Chrome" variant. Since both are replaced with Focus Browser,
