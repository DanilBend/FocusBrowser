...
PRUNING_EXCLUDE_PATTERNS = [
    ...
    # Exclusions for Focus Browser onboarding
    'components/focus_onboarding/node_modules/@esbuild/*/bin/esbuild',
    'components/focus_onboarding/node_modules/@esbuild/*/esbuild.exe',
    'components/focus_onboarding/node_modules/@rollup/*/rollup.*.node',
    'components/focus_onboarding/node_modules/fsevents/fsevents.node',
