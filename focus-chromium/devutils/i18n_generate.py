...
"""
String extraction from Focus Browser patches for translation.
"""
...
REPO_URL = "https://github.com/imputnet/focus-{repo}.git"
...
def extract_strings(repo_root, platforms_dir):
    ...
    onboarding_path = platforms_dir / "onboarding" / "focus_onboarding_strings.grdp"
    if onboarding_path.exists():
        ...
        for source in extract_strings_from_hunk(onboarding_text, True):
            yield from to_source_format(
                'components/focus_onboarding/focus_onboarding_strings.grdp', *source)
